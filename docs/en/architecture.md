...
- ADR 0003: Skill / Project / Vault 3-layer structure *(English translation pending)*
- ADR 0004: Keeping Project Instructions very thin *(English translation pending)*
- Philosophy: GitHub-as-a-Backend
- Reference-Level System spec *(English translation pending)*
