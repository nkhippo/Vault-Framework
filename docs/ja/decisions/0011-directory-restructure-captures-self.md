...
- **個人領域の欠如**: 日記や振り返り、目標など、あなた(導入者) の個人的な記録を置く適切な場所がなかった(90_inbox/ に投げるのは違和感)
- **handoff/ が Vault-Framework にしかない**: ADR-0010 で導入した handoff/ 領域が、他のプロジェクト(<your-project>、<your-project>-* 等)には未展開
