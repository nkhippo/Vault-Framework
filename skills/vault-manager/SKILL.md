...
description: Use this skill when the user asks to save chat content to the personal
  ...
  "〜の詳細見せて", "〜の状態は", and similar backlog listing or review requests.
...
### 保存系(新規起票、昇格、Cursor 委譲連携)は Phase 1d の対象

参照中に Naoya が新規起票を要求した場合、暫定的に「open-questions.md への追記提案」で応答(Phase 1d 完了まで)。
